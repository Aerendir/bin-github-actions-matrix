...
class MatrixTest extends TestCase
{
    ...
    public function testExclusionsWithExcludedKeyWithOneElementAreHandledLikeExclude(): void
    {
        $matrixInput = [
            'php' => [
                '8.3',
    ...
    public function testExclusionsWithExcludedKeyWithTwoElementsAreHandledLikeExclude(): void
    {
        $matrixInput = [
            'php' => [
                '8.2',
